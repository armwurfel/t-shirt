                        ...
                        <div className="product">
                            ...
                            <div className="canvascontainer-pagecontainer-design">
                                ...
                                <div className="design-printablearea">
                                    ...
                                    <DesignIcon textCenter={this.props.textCenter} iconActiveStatus={this.props.iconActiveStatus} iconActiveKey={this.props.iconActiveKey} iconActiveType={this.props.iconActiveType} handleIconActive={this.props.handleIconActive} type="1" keys="1" shapeValue={this.props.shapeValue} shape={this.props.shape} outlineSize={this.props.outlineSize} outlineColor={this.props.outlineColor} textRotation={this.props.textRotation} textColor={this.props.textColor} font={this.props.font} handleTextFrontValue={this.handleTextFrontValue} TextFrontValue={this.props.TextFrontValue}/>
                                    <DesignIconImg iconCenter={this.props.iconCenter} iconActiveStatus={this.props.iconActiveStatus} iconActiveKey={this.props.iconActiveKey} iconActiveType={this.props.iconActiveType} handleIconActive={this.props.handleIconActive} type="2" keys="1" artIconId={this.props.artIconId}  font={this.props.font} iconRotation={this.props.iconRotation} handleTextFrontValue={this.handleTextFrontValue} TextFrontValue={this.props.TextFrontValue}/>
