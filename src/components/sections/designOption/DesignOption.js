                        ...
                        <div className="design-option-change-view">
                            <div 
                                ...
                                <div className="design-option-changeviewbutton menubutton">
                                    <div className="design-option-changeView">
                                        <div>
                                            <img src={`./assets/images/product-images/${this.props.productColor}/front_medium_extended.png`} alt="front-img" />
                                        </div>
                                    </div>
                            ...
                            <div 
                                ...
                                <div className="design-option-changeviewbutton menubutton">
                                    <div className="design-option-changeView">
                                        <div>
                                            <img src={`./assets/images/product-images/${this.props.productColor}/back_medium_extended.png`} alt="front-img" />
                                        </div>
                                    </div>
                                    <div className="design-option-menubutton-text">
                                        back
