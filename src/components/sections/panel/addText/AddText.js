                    ...
                    <div className="textcard-container">
                        <div className="textinput">
                            <label className="textinput-textarea-container">
                                <textarea className="textinput-textarea" name="text" placeholder="Enter text here" rows="1" type="text">
                                </textarea>
                            </label>
                            ...
                            <div>
                                ...
                                <div className="iconcardtool iconcardtool-font iconcardtool-clickable">
                                    ...
                                    <div className="iconcardtool-content">
                                        <img className="foundryimage" draggable="false" src="//www.customink.com/text/v1/gen?op[fnt]=Aromatica-Bold&amp;op[ht]=30&amp;op[sf]=1&amp;op[txt]=Aromatica%20Bold&amp;op[r]=0&amp;op[g]=0&amp;op[b]=0&amp;op[a]=center&amp;op[ro]=0&amp;op[lr]=false" />
                                    </div>
